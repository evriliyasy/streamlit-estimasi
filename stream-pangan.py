...
if st.button('Estimasi Harga'):
    predict = model.predict([[Beras_Termurah, Bawang_Merah, Telur_Ayam, Cabe_Merah_Keriting, Daging_Ayam, Daging_Sapi, Gula_Pasir, Cabe_Merah_Besar, Jagung, Kedelai, Minyak_Goreng]])
